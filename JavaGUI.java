...
public class summativeGUI {
    ...
    /**
     * This function shows an option bar for the user
     */
    public static void optionsBar() {
		...
		/**
		 * This function will listen for when the save button is pressed
		 */
		...
		/**
		 * This function will save the current image as a png
		 */
		...
		/**
		 * Listend for when the use selects the exit button
		 */
		...
		/**
		 * This function will restore the image to it's original
		...
		/**
		 * This function will grescale the image
		 */
		...
		/**
		 * Adds a red tint to the image similar to how old photos look like
		 */
		...
		/**
		 * This function inverts the colour ofthe image
		 */
		...
		/**
		 * This function will aplly gaussian blur to the image
		 */
		...
		/**
		 * This function will make the image bulge at the center
		 */
